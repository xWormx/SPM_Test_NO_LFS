...
#include "SGFlyingEnemyCharacter.h"

#include "GameFramework/CharacterMovementComponent.h"
#include "Kismet/GameplayStatics.h"
#include "Net/Core/Analytics/NetStatsUtils.h"

ASGFlyingEnemyCharacter::ASGFlyingEnemyCharacter()
{
...
void ASGFlyingEnemyCharacter::BeginPlay()
{
	Super::BeginPlay();
...
void ASGFlyingEnemyCharacter::Tick(float DeltaTime)
{
